package com.party.SMS;

import java.io.BufferedReader;
import java.io.IOException;
import java.io.InputStreamReader;

import com.party.SMS.client.AbsRestClient;
import com.party.SMS.client.JsonReqClient;
import com.party.SMS.client.XmlReqClient;
...
public class ToolSMS{
	...
	public static void sendVerifySMS(String para,String to)
	{
		boolean json=true;
		String accountSid="f716ead5226ceef5cd58ef6e4c4c1d59";
		String token="1d7508e06aa276bc80826eb20462d379";
		String appId="1c3eb727d2f745539f11473eff201c11";
		String templateId="88623";
		//String to="15678390463";
	...
	public static void sendInformSMS(String para)
	{
		boolean json=true;
		String accountSid="f716ead5226ceef5cd58ef6e4c4c1d59";
		String token="1d7508e06aa276bc80826eb20462d379";
		String appId="d6d8fc5ec6ef40aa86dab9de572bb851";
		String templateId="89570";
		String to="18978323457";
		//String para="0000";
	...
	public static boolean sendTOTPSMS(String seed,String verify)
	{
		String totp=TOTP.getTOTP(seed);
		if(verify.equals(totp))
			return true;
